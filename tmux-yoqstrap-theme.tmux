...
set "status-right" "#[fg=$white,bg=$black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$visual_grey,bg=$black]#[fg=$visual_grey,bg=$visual_grey] #h #[fg=$yellow, bg=$pink]#[fg=$red,bg=$yellow]"
