...
set "status-right" "#[fg=$white,bg=$black,nounderscore,noitalics]${time_format}  ${date_format}#[fg=$white, bg=$visual_grey] #[fg=$pink,bg=$visual_grey,nobold,nounderscore,noitalics]#[fg=$black,bg=$pink,bold] #h #[fg=$yellow, bg=$pink]#[fg=$red,bg=$yellow]"
