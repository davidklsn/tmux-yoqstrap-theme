...
set "status-right" "#[fg=$white,bg=$black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$visual_grey,bg=$black]#[fg=$visual_grey,bg=$visual_grey]#[fg=$white, bg=$visual_grey]#[fg=$pastel_blue,bg=$visual_grey,nobold,nounderscore,noitalics]#[fg=$white,bg=$pastel_blue,bold] #h #[fg=$yellow, bg=$pastel_blue]#[fg=$red,bg=$yellow]"
